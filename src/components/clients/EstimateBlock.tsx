          ...
          <div className="grid grid-cols-3 gap-4">
            <EstimateTable
              ...
              rows={[
                ...
                { label: 'Бикрост', value: foundationValues.bikrost.value, isChecked: foundationValues.bikrost.isChecked, onChange: handleFoundationChange('bikrost'), onCheckChange: handleFoundationCheckChange('bikrost') }
              ]}
              isEditing={isEditing}
            />
